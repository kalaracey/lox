...
public class GenerateAst {
  ...
  private static void defineAst(File outputDir, String baseName, List<String> types)
      throws IOException {
    String pkg = "com.laracey.lox.interpreter";
    String dirname = pkg.replace('.', '/');
    File dir = new File(outputDir, dirname);
    dir.mkdirs();
    // String path = dirname + "/" + baseName + ".java";
    PrintWriter writer = new PrintWriter(new File(dir, baseName + ".java"), "UTF-8");
