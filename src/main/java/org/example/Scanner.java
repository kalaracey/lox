...
public class Scanner {
  ...
  /**
   * Like a conditional {@link #advance()}.
   *
   * <p>Only consumes the current character if it's what we're looking for.
   */
  ...
  /** Lookahead: like {@link #advance()}, but doesn't consume the character. */
  private char peek() {
    if (isAtEnd()) return '\0';
    return source.charAt(current);
  }
